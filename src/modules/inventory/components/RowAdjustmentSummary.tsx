...
export const RowAdjustmentSummary = ({ product }) => {
    ...
    const { removeProductFromSale, productQuantity, productAdjustment } = useContext(SaleContext)
    return (
        <>
            <tr className={styles.row}>
                ...
                <td className={styles.category}>
                    <select className={styles.selectFilterAdjustment} onChange={(e) => productAdjustment(id, e.target.value)}>
